...
class Mtb(fewshot_re_kit.framework.FewShotREModel):
    ...
    def __init__(self, sentence_encoder, use_dropout=True, combiner="max"):
        ...
        self.layer_norm = torch.nn.LayerNorm(1536 * (2 if sentence_encoder.cat_entity_rep else 1)) #sentence_encoder.bert.config.hidden_size // 1536
    ...
    def forward(self, support, query, N, K, total_Q):
        ...
        hidden_size = 1536 #1536  // support.size(-1)
        if self.use_dropout:
